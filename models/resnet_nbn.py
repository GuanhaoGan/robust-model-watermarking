...
from models.nbn import NoisyBatchNorm2d
...
def ResNetNBN18(num_classes=10, norm_layer=NoisyBatchNorm2d):
    return ResNetNBN(BasicBlock, [2, 2, 2, 2], num_classes, norm_layer)


def ResNetNBN50(num_classes=10, norm_layer=NoisyBatchNorm2d):
    return ResNetNBN(Bottleneck, [3, 4, 6, 3], num_classes, norm_layer)
...
def test():
    ...
    print(y.size())
    net.bn1.neuron_mask.requires_grad_(False)
